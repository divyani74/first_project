...
<div class="container mt-4">
  <div class="center-container">
    <h1 style="color:green;margin-top:-70px;">Farmer Registration  <img src="/images/industry.png" alt="Agency Logo" style="width: 50px; height: 50px; float: right;"></h1>
  </div>
</div>
<div class="container mt-4">
  <table class="table table-bordered">
    <thead>
      <tr>
        ...
        <th scope="col" style="background-color: green; color: white;">Farmer Name</th>
    ...
    <tbody>
    <c:forEach items="${mm}" var="b">
      <tr>
        <th scope="row">${b.fid}</th>
        <td>${b.fname}</td>
        <td>${b.femail}</td>
        <td>${b.fpassword}</td>
      <td>
      <a href="delete/${b.fid}">Delete</a>
      </td>
      </tr>
    </c:forEach>
    </tbody>
