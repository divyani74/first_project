...
<div class="container mt-4">
  <div class="center-container">
      <h1 style="color:green;margin-top:-70px;">Student Registration<img src="/images/industry.png" alt="Agency Logo" style="width: 50px; height: 50px; float: right;"></h1>
  </div>
</div>
<div class="container mt-4">
  <table class="table table-bordered">
    <thead>
      <tr>
        ...
        <th scope="col" style="background-color: green; color: white;">Student Name</th>
        <th scope="col" style="background-color: green; color: white;">Email</th>
        <th scope="col" style="background-color: green; color: white;">Password</th>
        <th scope="col" style="background-color: green; color: white;">Action</th>
      </tr>
    </thead>
    <tbody>
    <c:forEach items="${mm}" var="a">
      <tr>
        <th scope="row">${a.sid}</th>
        <td>${a.sname}</td>
        <td>${a.semail}</td>
        <td>${a.spassword}</td>
        <td>
        <a href="dele/${a.sid}">Delete</a>
        </td>
      </tr>
    </c:forEach>
    </tbody>
