...
<div class="container mt-4">
  <div class="center-container">
    <h1 style="color:green;margin-top:-70px;">Soil Analysis   <img src="/images/plant.png" alt="Agency Logo" style="width: 50px; height: 50px; float: right;"></h1>
  </div>
</div>
<div class="container mt-4">
  <table class="table table-bordered">
    <thead>
      <tr>
        ...
        <th scope="col" style="background-color: green; color: white;">Mo_No</th>
        <th scope="col" style="background-color: green; color: white;">Location</th>
        <th scope="col" style="background-color: green; color: white;">Email</th>
         <th scope="col" style="background-color: green; color: white;">Depth</th>
         <th scope="col" style="background-color: green; color: white;">Type of Soil</th>
         <th scope="col" style="background-color: green; color: white;">Soil Description</th>
         <th scope="col" style="background-color: green; color: white;">Organic Matter</th>
         <th scope="col" style="background-color: green; color: white;">Texture</th>
         <th scope="col" style="background-color: green; color: white;">Crop Type</th>
         <th scope="col" style="background-color: green; color: white;">Previous Crop</th>
         <th scope="col" style="background-color: green; color: white;">Fertilizers Used</th>
         <th scope="col" style="background-color: green; color: white;">Irrigation</th>
         <th scope="col" style="background-color: green; color: white;">Action</th>
      </tr>
    </thead>
    <tbody>
    <c:forEach items="${mm}" var="d">
      <tr>
        <th scope="row">${d.tid}</th>
        <td>${d.tname}</td>
        <td>${d.tno}</td>
        <td>${d.tlocation}</td>
        <td>${d.temail}</td>
         <td>${d.tdepth}</td>
         <td>${d.ttype}</td>
         <td>${d.tsoildescription}</td>
         <td>${d.torganicmatter}</td>
         <td>${d.ttexture}</td>
         <td>${d.tcroptype}</td>
         <td>${d.tpreviouscrop}</td>
         <td>${d.tfertilizeruse}</td>
         <td>${d.tirrigation}</td>
         <td>
          <a href="tdel/${d.tid}">Delete</a>
         </td>
      </tr>
    </c:forEach>
    </tbody>
