...
<body>
  ...
  <div class="center-container">
    <h1 style="color:green;margin-top:-70px;">Registered Agro Agency  <img src="/images/industry.png" alt="Agency Logo" style="width: 50px; height: 50px; float: right;"></h1>
  </div>
</div>
<div class="container mt-4">
  <table class="table table-bordered" style="margin-top:50px;">
    <thead>
      <tr>
        ...
        <th scope="col" style="background-color: green; color: white;">Agency Name</th>
        <th scope="col" style="background-color: green; color: white;">Address</th>
