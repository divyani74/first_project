...
<div class="container mt-4">
  <div class="center-container">
    <h1 style="color:green;margin-top:-70px">Feedback<img src="/images/feedback.png" alt="Agency Logo" style="width: 50px; height : 50px; float: right;"></h1>
  </div>
</div>
<div class="container mt-4">
  <table class="table table-bordered">
    <thead>
      <tr>
        ...
        <th scope="col" style="background-color: green; color: white;">Subject</th>
        <th scope="col" style="background-color: green; color: white;">Feedback</th>
         <th scope="col" style="background-color: green; color: white;">Action</th>
      </tr>
    </thead>
    <tbody>
    <c:forEach items="${mm}" var="c">
      <tr>
