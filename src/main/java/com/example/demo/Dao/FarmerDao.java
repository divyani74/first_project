...
public class FarmerDao implements FarmerService {
	...
	@Override
	public Farmer checkdata(String fname) {
		// TODO Auto-generated method stub
		return fp.findByFname(fname);
	}

	@Override
	public Farmer CheckBoth(String fname, String fpassword) {
		
		return fp.findByFnameAndFpassword(fname, fpassword);
	}
